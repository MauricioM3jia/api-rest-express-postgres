...
const router = Router();
   ...
   router.put('/api/dashboard/update/:id',jwt.tokenExist,taskController.UpdateTask);

   router.get('/api/dashboard',jwt.tokenExist,taskController.getTasks);

   router.delete('/api/dashboard/task/:id',jwt.tokenExist,taskController.deleteTask);
